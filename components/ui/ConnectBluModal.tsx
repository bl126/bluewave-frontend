            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed bottom-0 left-0 right-0 z-[201] bg-gradient-to-b from-[#050d14] to-black border-t border-cyan-500/20 rounded-t-[2.5rem] overflow-hidden"
                    >
                        {/* Handle bar */}
                        ...
                        <div className="flex items-center justify-between px-6 pb-4">
                            <div>
                                ...
                                <p className="text-cyan-500/50 text-[10px] font-bold uppercase tracking-widest">Bluewave Intelligence Agent</p>
                            </div>
                            <button onClick={handleClose} className="p-2 rounded-full bg-white/5 text-cyan-500/40 hover:text-cyan-400 transition-colors">
                                <X size={16} />
                            </button>
                        </div>
