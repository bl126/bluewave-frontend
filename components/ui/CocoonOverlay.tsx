...
import { Shield, Cpu, Link as LinkIcon, ExternalLink, Lock } from "lucide-react";
                ...
                <div className="relative w-36 mb-6">
                  ...
                  >
                    <img 
                      src="/cocoon_egg.webp" 
                      alt="Cocoon Egg" 
                      className="w-full h-auto drop-shadow-[0_0_25px_rgba(255,255,255,0.15)] pointer-events-none select-none"
