            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed bottom-0 left-0 right-0 z-[1009] bg-app-card border-t border-app-border rounded-t-[2.5rem] flex flex-col max-h-[85vh] shadow-app-shadow text-text-main backdrop-blur-2xl"
                    >
                        {/* Drag Handle */}
                        <div
