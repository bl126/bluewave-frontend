...
export default function Profile({ isOpen, onClose, telegramUser, onOpenRoles, onOpenBwaveScan, onOpenEcosystemRoles, onOpenBugsSuggestions }: ProfileProps) {
  ...
  return (
    <motion.div
      className={`fixed inset-0 flex flex-col overflow-hidden text-text-main bg-app-bg/95 backdrop-blur-3xl transition-all duration-300 ${isSubSheetOpen ? "z-[300]" : "z-[120]"}`}
