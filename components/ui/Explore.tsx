...
export default function Explore({ isOpen, onClose, telegramUser, onGoToProfile }: ExploreProps) {
  ...
  return (
    <motion.div
      ...
      className={`fixed inset-0 flex flex-col overflow-hidden text-text-main bg-app-bg ${(isPostModalOpen || isLeaderboardSheetOpen || isSearchOpen || isReferralModalOpen || isConnectBluOpen) ? "z-[1100]" : "z-[120]"}`}
      style={{
